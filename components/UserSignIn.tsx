...
const UserSignIn: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast("Giriş sırasında beklenmedik bir hata oluştu.", "error");
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 space-y-6 ring-1 ring-gray-200">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm text-gray-600">Takım panonuza giriş yapın</p>
        </div>
